"""
Training script for MMD (Maximum Mean Discrepancy)
...
- Minimizes MMD loss to reduce domain distribution distance
"""
...
class MMDTrainer:
    ...
    def __init__(self,
        ...
        # History
        self.history = {
            'train_class_loss': [], 'train_mmd_loss': [], 'train_total_loss': [],
            'train_acc': [],
            'val_loss': [], 'val_acc': [],
            'learning_rates': []
        }
    ...
    def train_epoch(self, epoch):
        """Train for one epoch with MMD loss"""
        self.model.train()
        ...
        for ct_images, ct_labels in pbar:
            ...
            with autocast():
                ...
                mmd_loss_value = mmd_loss(ct_features, xray_features)
                
                # Total loss
                loss = class_loss + self.mmd_weight * mmd_loss_value
            ...
            total_mmd_loss += mmd_loss_value.item() * (batch_size * 2)
        ...
        return epoch_class_loss, epoch_mmd_loss, epoch_total_loss, epoch_acc
    ...
    def train(self):
        ...
        for epoch in range(1, self.num_epochs + 1):
            ...
            # Train
            class_loss, mmd_loss_val, total_loss, train_acc = self.train_epoch(epoch)
            ...
            self.history['train_mmd_loss'].append(mmd_loss_val)
            ...
            print(f"  Train MMD Loss: {mmd_loss_val:.4f}")
...
def main():
    ...
    trainer = MMDTrainer(
        ...
        num_epochs=20,
        batch_size=32,
        mmd_weight=1.0,  # Weight for MMD loss
        device='cuda:1'
    )
